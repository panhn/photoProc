#include <iostream> 
#include "func.hpp"
#include "ColorStyleTransfer.hpp"
...
int main()
{
	...
	createTrackbar("lumdegree", windowname, &lumdegree, maxValue, onRemoveNoise);
	createTrackbar("lumclear", windowname, &lumclear, maxValue, onRemoveNoise);
	createTrackbar("colordegree", windowname, &colordegree, maxValue, onRemoveNoise);
	createTrackbar("colorclear", windowname, &colorclear, maxValue, onRemoveNoise);
